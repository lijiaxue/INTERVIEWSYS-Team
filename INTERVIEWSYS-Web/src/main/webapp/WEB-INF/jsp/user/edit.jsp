...
<title>編輯</title>
<link href="${contextPath}/css/content-base.css"
	rel="stylesheet" />
<link href="${contextPath}/lib/bootstrap-Switch/bootstrapSwitch.css"
	rel="stylesheet" />
</head>
<body class="gray-bg">
	...
	<script src="${contextPath}/js/content/base.js"></script>
	<script src="${contextPath}/js/content/action.js"></script>
	<script src="${contextPath}/js/content/jqueryValidator.js"></script>
	<script src="${contextPath}/lib/bootstrap-Switch/bootstrapSwitch.js"></script>
