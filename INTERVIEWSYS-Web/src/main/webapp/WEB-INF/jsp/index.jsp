...
<div class="layui-layout layui-layout-admin" id="layui_layout">
            ...
            <div class="layui-larry-menu">
                 <ul class="layui-nav clearfix">
                       <li class="layui-nav-item layui-this">
                 	   	   <a href="/roleUser/index.jsp"><i class="iconfont icon-wangzhanguanli"></i>内容管理</a>
                 	   </li>
                 	   <li class="layui-nav-item">
                 	   	   <a href="javascirpt:;"><i class="iconfont icon-ht_expand"></i>角色管理</a>
                 	   </li>
                 	   <li class="layui-nav-item">
	...
	<div class="layui-side layui-side-bg layui-larry-side" id="larry-side">
		...
		<ul class="layui-nav layui-nav-tree">
			<li class="layui-nav-item layui-this">
				<a href="javascript:;" data-url="${contextPath}/main">
			...
			<!-- 个人信息 -->
				...
				<dl class="layui-nav-child">
                    <dd>
                        <a href="javascript:;" data-url="${contextPath}/user/user">
